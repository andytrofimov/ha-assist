...
Функция: Вопросы состояния умного дома
  ...
  Предыстория:
    Дано доступны сущности:
      ...
      | binary_sensor.okno_kabinet_contact       | Окно кабинет            | off   |                       | kabinet   | Кабинет   | tretii   | Третий     |                     |                        |
  ...
  Сценарий: Ответить на несовпавшее состояние бинарного сенсора среднего рода
    Когда пользователь говорит "окно в кабинете открыто?"
    Тогда ответ ассистента равен "нет, закрыто"
    И ассистент не вызывает сервисы

  Сценарий: Вернуть имя и согласованное состояние бинарного сенсора среднего рода
    Когда пользователь говорит "что с окном в кабинете"
    Тогда ответ ассистента равен "окно закрыто"
    И ассистент не вызывает сервисы
...
#    todo поправить тест под ожидаемое поведение
